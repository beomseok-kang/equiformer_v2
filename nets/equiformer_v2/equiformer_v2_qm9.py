...
_AVG_DEGREE     = 15.57930850982666   # IS2RE: 100k, max_radius = 5, max_neighbors = 100
...
class EquiformerV2_QM9(BaseModel):
    ...
    def forward(self, data):
        ...
        energy = torch.zeros(len(data.name), device=node_energy.device, dtype=node_energy.dtype)
